...
result=[]
for i in range(62):
    result.append(float(((3*temp101[i])+(3*temp103[i])+(3*temp105[i])+(3*temp107[i])+(3*temp109[i])+(2*temp111[i])+temp108[i]+temp114[i]+temp100[i])/20))
...
for i in range(62):
    j = int(cse_100.iloc[i:i + 1]['Exam Roll'])
    if j==roll:
